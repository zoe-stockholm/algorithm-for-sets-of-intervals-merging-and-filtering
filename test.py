...
class TestMerge(unittest.TestCase):
    ...
    def test_case_4(self):
        ...
        merged_excludes = merge_intervals(excludes)
        after_sub = intervals_sub(merged_includes, merged_excludes)
        self.assertEqual(after_sub, [(10, 94), (206, 300), (400, 409), (421, 500)])
    ...
    def test_case_8(self):
        ...
        merged_excludes = merge_intervals(excludes)
        after_sub = intervals_sub(merged_includes, merged_excludes)
        self.assertEqual(after_sub, [(6, 9), (21, 29), (41, 49), (61, 200), (300, 400)])
    ...
    def test_case_10(self):
        ...
        merged_excludes = merge_intervals(excludes)
        after_sub = intervals_sub(merged_includes, merged_excludes)
        self.assertEqual(after_sub, [(1, 200), (300, 319), (331, 339), (351, 400), (500, 600)])
    ...
    def test_case_11(self):
        ...
        merged_excludes = merge_intervals(excludes)
        after_sub = intervals_sub(merged_includes, merged_excludes)
        self.assertEqual(after_sub, [(1, 119), (331, 339), (351, 400), (500, 600), (700, 800), (900, 919), (931, 1000)])
